      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a className="text-gray-400 hover:text-[#f97815] text-sm transition-colors" href={GITHUB_CONFIG.readmeUrl} target="_blank" rel="noopener noreferrer">Documentation</a>
            <a className="text-gray-400 hover:text-[#f97815] text-sm transition-colors" href={GITHUB_CONFIG.repoUrl} target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
        ...
        <div className="border-t border-[#3a2f27] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">© 2026 ModelHub. All rights reserved.</p>
