...
interface PxpipeModalProps {
  showPxpipeModal: boolean;
  setShowPxpipeModal: (v: boolean) => void;
  pxpipeStatus: { installed: boolean; installing: boolean; running: boolean; version: string | null };
  pxpipeHealthy: boolean;
  pxpipeStatusLabel: string;
  pxpipeHealth: PxpipeHealthData | null;
  pxpipeMinChars: number;
  setPxpipeMinChars: (v: number) => void;
  handlePxpipeMinCharsBlur: () => void;
  pxpipeActionLoading: boolean;
  pxpipeActionError: string;
  pxpipeAction: (endpoint: string) => void;
  refreshPxpipeStatus: () => Promise<void>;
  runPxpipeHealth: () => Promise<void>;
}
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <Input
            ...
            onChange={(e) => setPxpipeMinChars(Number(e.target.value) || 0)}
