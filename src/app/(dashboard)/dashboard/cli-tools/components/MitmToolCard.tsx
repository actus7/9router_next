...
export default function MitmToolCard({
  tool, isExpanded, onToggle, serverRunning, dnsActive, hasCachedPassword, needsSudoPassword, isWin,
  apiKeys, activeProviders, hasActiveProviders, modelAliases = {}, cloudEnabled, onDnsChange,
}: MitmToolCardProps) {
  ...
  const handleModelSelect = (model: { value: string; isPlaceholder?: boolean }) => {
