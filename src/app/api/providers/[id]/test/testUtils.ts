  ...
  try {
    switch (connection.provider) {
      ...
      case "azure": {
        ...
        const headers: Record<string, string> = { "api-key": connection.apiKey as string, "Content-Type": "application/json" };
        if (psd.organization) headers["OpenAI-Organization"] = psd.organization as string;
        const res = await fetchWithConnectionProxy(url, {
          method: "POST", headers,
      ...
      case "anthropic": {
        const res = await fetchWithConnectionProxy("https://api.anthropic.com/v1/messages", {
          method: "POST",
          headers: { "x-api-key": connection.apiKey as string, "anthropic-version": "2023-06-01", "content-type": "application/json" },
      ...
      case "minimax":
      case "minimax-cn": {
        const endpoints: Record<string, string> = { minimax: "https://api.minimax.io/anthropic/v1/messages", "minimax-cn": "https://api.minimaxi.com/anthropic/v1/messages" };
        const res = await fetchWithConnectionProxy(endpoints[connection.provider as string], {
          method: "POST",
          headers: { "x-api-key": connection.apiKey as string, "anthropic-version": "2023-06-01", "content-type": "application/json" },
      ...
      case "xiaomi-tokenplan": {
        const baseUrls: Record<string, string> = { "xiaomi-mimo": "https://api.xiaomimimo.com/v1", "xiaomi-tokenplan": "https://token-plan-sgp.xiaomimimo.com/v1" };
      ...
      case "llm7": {
        const baseUrl = ((connection.providerSpecificData as Record<string, unknown>)?.baseUrl as string) || "https://api.llm7.io/v1";
