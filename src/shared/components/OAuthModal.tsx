        ...
        {(step === "waiting" || step === "input") && !isDeviceCode && !(provider && PROXY_OAUTH_PROVIDERS.has(provider)) && (
          <>
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-sm font-medium mb-2">
                  {translate("Step 2: Paste the callback URL here")} {provider === "xai" ? (translate("or copied code") ?? "or copied code") : isKimchiProvider ? (translate("or copied token") ?? "or copied token") : ""}
                </p>
