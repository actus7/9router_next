        ...
        <div className="p-6 max-h-[calc(85vh-100px)] overflow-y-auto custom-scrollbar">
          <div className="flex flex-col gap-4">
            ...
            {!f.isOAuth && (<>
              ...
              {f.validationResult && (<Badge variant={f.validationResult === "success" ? "success" : "destructive"}>{f.validationResult === "success" ? translate("Valid") || "Valid" : translate("Invalid") || "Invalid"}</Badge>)}
            </>)}
            {f.isAzure && (
            ...
            {!f.isCompatible && !f.isAzure && !f.isCloudflareAi && (
              <div className="flex items-center gap-3">
                ...
                {f.testResult && (<Badge variant={f.testResult === "success" ? "success" : "destructive"}>{f.testResult === "success" ? translate("Valid") || "Valid" : translate("Failed") || "Failed"}</Badge>)}
              </div>
            )}
            <div className="flex gap-2">
