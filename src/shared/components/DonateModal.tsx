...
export default function DonateModal({ isOpen, onClose }: DonateModalProps) {
  ...
  useEffect(() => {
    ...
    fetch(GITHUB_CONFIG.donateUrl, { cache: "no-store" })
      ...
      .then((json: DonateData) => setData(json))
...
interface DonateChannelCardProps {
  channel: DonateChannel;
}

function DonateChannelCard({ channel }: DonateChannelCardProps) {
