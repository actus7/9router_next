 ...
 * API. They are modelhub fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic modelhub variant set for a single upstream Kiro model.
 *
 ...
 * into modelhub variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
