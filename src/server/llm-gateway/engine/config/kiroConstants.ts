 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what modelhub needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a modelhub
 ...
 * The suffix is a modelhub request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id is a modelhub synthetic thinking variant
...
/**
 * Resolve a modelhub model id to the real upstream Kiro model id, plus flags
