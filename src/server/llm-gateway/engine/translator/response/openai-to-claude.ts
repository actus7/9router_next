...
function trackChunkUsage(chunk: Record<string, unknown>, state: Record<string, unknown>) {
...
// Emit message_start event on first chunk
function ensureMessageStart(chunk: Record<string, unknown>, state: Record<string, unknown>, results: Record<string, unknown>[]) {
...
// Handle reasoning (thinking) delta across vendor shapes
function handleReasoningDelta(delta: Record<string, unknown>, state: Record<string, unknown>, results: Record<string, unknown>[]) {
...
function handleTextDelta(delta: Record<string, unknown>, state: Record<string, unknown>, results: Record<string, unknown>[]) {
...
// Handle tool call deltas — open blocks and buffer arguments
function handleToolCallDeltas(delta: Record<string, unknown>, state: Record<string, unknown>, results: Record<string, unknown>[]) {
...
function openaiToClaudeResponse(chunk: Record<string, unknown>, state: Record<string, unknown>) {
  ...
  trackChunkUsage(chunk, state);
  ensureMessageStart(chunk, state, results);
  handleReasoningDelta(delta as Record<string, unknown>, state, results);
  handleTextDelta(delta as Record<string, unknown>, state, results);
  handleToolCallDeltas(delta as Record<string, unknown>, state, results);

  if (choice.finish_reason) {
    handleFinish(choice, state, results);
  }
